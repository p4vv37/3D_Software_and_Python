...
def prepare_scene(path):
    ...
    cam = cmds.camera(name = "RenderCamera") # create camera to set its background
...
def create_shark_and_cloud():
    ...
    shark_verts_pos = [[-2.42281, -0.814631, 1.55561], [0.0166863, -0.854455, 1.91858], [-2.42281, -0.482041, 1.55561],
                 ...
                 [-2.54367, -0.475272, -0.819357], [0.422536, -0.421143, -0.277747], [0.422536, -0.875526, -0.277747]]
    ...
    set_scale_keys(target=shark_node_name, keyframes=[[0.001, 9], [1, 15]])
    cmds.move(-9.18464, -4, -54.9695, shark_node_name, absolute=True)   # Set position

    cloud_verts_pos = [[0, [-4.59048,  -11.5324,  -2.85738]], [1, [4.19166,  -11.3976,  -1.66769]],
                  [2, [-2.72098,  4.70308,  -0.947684]], [3, [5.35751,  5.31851,  -1.84713]],
                  [4, [-2.55545,  -10.6202,  1.76613]], [5, [6.33762,  -11.4932,  3.83193]],
                  [6, [-4.05797,  5.18567,  4.01239]], [7, [5.16506,  4.23825,  3.03181]],
                  [8, [-7.57451,  -3.27952,  -1.45211]], [9, [-5.04695,  -3.47346,  -2.50455]],
    ...
    cloud_face_verts = [[0, [0, 21, 205]], [1, [205, 70, 0]], [2, [21, 22, 205]], [3, [22, 23, 205]], [4, [23, 24, 274]],
                  [5, [24, 25, 324]], [6, [25, 26, 229]], [7, [26, 27, 229]], [8, [27, 9, 229]], [9, [205, 71, 70]],
                  [10, [205, 72, 71]], [11, [205, 73, 72]], [12, [205, 74, 73]], [13, [312, 75, 74]],
                  [14, [312, 76, 75]], [15, [312, 12, 76]], [16, [28, 2, 35]], [17, [35, 304, 28]], [18, [304, 35, 36]],
                  [19, [304, 36, 37]], [20, [304, 37, 38]], [21, [304, 38, 39]], [22, [232, 39, 40]],
    ...
    set_scale_keys(target=cloud_node_name, keyframes=[[0.001, 62], [1.1, 67], [1, 69]])
    cmds.move(-9.18464,  31, 39.500, cloud_node_name, absolute=True)
    set_position_keys(target=cloud_node_name, keyframes=[[[2.409, 31.7, 39.500], 69, [5, 5]],
